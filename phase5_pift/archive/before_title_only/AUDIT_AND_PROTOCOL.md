...
- WANDS has no query-facet annotations. Protect title always; for positives,
  conservatively protect all scalar sections and attributes sharing a non-stopword
  query token. This is a lexical proxy, not verified facet annotation; it may miss
  implicit relevance evidence. Record protected fields and observed dropout.
